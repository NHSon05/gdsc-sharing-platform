...
<div
  class="bg-brand-muted border-brand-border text-brand inline-flex items-center gap-1.5 rounded-full border px-3 py-1 text-xs font-semibold"
>
...
<div
  class="hover:border-brand/60 rounded-3xl border border-zinc-100 bg-white p-6 transition-all duration-300 hover:shadow-[0_20px_40px_-15px_var(--brand-glow)] dark:border-zinc-800 dark:bg-zinc-900"
>
  <h3 class="hover:text-brand text-xl font-bold">Tiêu đề bài viết</h3>
</div>
```
