...
export function CanvasLegend({ isOpen, onClose }: CanvasLegendProps) {
  ...
  return (
    <div className="animate-in fade-in slide-in-from-top-2 absolute top-20 left-6 z-30 w-72 rounded-2xl border border-neutral-300/90 bg-white/95 p-4 shadow-xl backdrop-blur-md duration-200 dark:border-zinc-800 dark:bg-zinc-900/95">
      <div className="flex items-center justify-between border-b border-neutral-200/80 pb-2.5 dark:border-zinc-800/80">
        <h4 className="text-xs font-bold tracking-wider text-neutral-900 uppercase dark:text-zinc-200">
          Roadmap Legend
        </h4>
        <button
          type="button"
