  ...
  return (
    ...
    >
      <div className="flex min-w-0 items-center gap-2 pr-2">
        ...
        {status === "Archived" && (
          <span className="py-0.2 flex shrink-0 items-center gap-0.5 rounded-md border border-amber-300 bg-amber-50 px-1.5 text-[9px] font-semibold text-amber-700 dark:border-amber-800 dark:bg-amber-950/40 dark:text-amber-300">
        ...
        {status === "Draft" && (
          <span className="py-0.2 flex shrink-0 items-center gap-0.5 rounded-md border border-neutral-300 bg-neutral-100 px-1.5 text-[9px] font-semibold text-neutral-700 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-300">
