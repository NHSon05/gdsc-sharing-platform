      ...
      <div className="space-y-6 pt-3 text-xs">
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 space-y-0.5">
            <span className="text-xs font-bold tracking-wider text-neutral-800 uppercase dark:text-zinc-500">
              EMAIL
            </span>
            <p className="truncate font-medium text-neutral-800 dark:text-zinc-500">
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 space-y-0.5">
            <span className="text-xs font-semibold tracking-wider text-neutral-800 uppercase dark:text-zinc-500">
              MÃ SỐ SINH VIÊN
            </span>
            <p className="truncate font-medium text-neutral-800 dark:text-zinc-200">
        ...
        {/* GitHub */}
        <div className="flex items-start gap-3">
          <div className="mt-0.5 size-6 shrink-0 text-neutral-800 dark:text-zinc-500">
          ...
          <div className="min-w-0 space-y-0.5">
            ...
            <p className="truncate font-medium text-neutral-800 dark:text-zinc-500">
              {profile.githubUrl ? (
                ...
                <span className="text-neutral-800 dark:text-zinc-500">
                  Chưa liên kết
                </span>
              )}
            </p>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 space-y-0.5">
            ...
            <p className="truncate font-medium text-neutral-800 dark:text-zinc-400">
