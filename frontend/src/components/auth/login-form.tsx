        ...
        <CardContent className="grid p-0">
          <form onSubmit={handleSubmit} className="p-6 md:p-8">
            <FieldGroup>
              ...
              {errorMessage && (
                <div className="animate-in fade-in rounded-xl border border-rose-500/20 bg-rose-500/10 p-3 text-center text-xs font-medium text-rose-600 dark:text-rose-400">
                  {errorMessage}
                </div>
              )}
