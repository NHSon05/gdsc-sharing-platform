export const en = {
  ...
  roadmaps: {
    ...
    subtitle: "Interactive 2D learning paths designed for developers. Explore topics, track prerequisites, unlock recommended tools, and download project resources.",
    ...
    noRoadmapsDesc: "Try adjusting your search query, clearing filters, or checking back later.",
