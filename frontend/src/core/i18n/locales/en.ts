export const en = {
  ...
  learning: {
    ...
    allCategories: "All",
    all: "All",
    totalQuestions: "Showing {range} of {total} interview questions",
    totalQuestionsEmpty: "Showing 0 interview questions",
    basicLevel: "Basic",
    intermediateLevel: "Intermediate",
    advancedLevel: "Advanced",
    basicLevelBadge: "BASIC",
    intermediateLevelBadge: "INTERMEDIATE",
    advancedLevelBadge: "ADVANCED",
    ...
    loadingDetail: "Loading detailed answer...",
    noAnswerYet: "No official answer yet for this question.",
    coreSummary: "Core Summary",
    keyPoints: "Key Points",
    copyCode: "Copy",
    codeCopied: "Copied",
    loadFailed: "Unable to load question list",
    loadFailedDesc: "An error occurred while connecting to the server.",
    retry: "Retry",
    notFoundTitle: 'No questions found matching "{search}"',
    emptyCategoryTitle: "No questions in this category",
    emptyDescription: "Try adjusting your search terms or select another category from the sidebar.",
